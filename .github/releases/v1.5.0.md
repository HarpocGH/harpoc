...
**Figures at the tag:** 13 packages · 109 error codes · 36 audit event types · 5926 passing / 39 skipped / 317 files (win32 host) · `ci.yml` 6/6 legs (Linux, Windows, macOS × Node 22, 24) at run 34106194890 · e2e harness 376/376 fleet tests (382/382 with the unit file) at run 34106194961 — measured at `3593a7d`, the standing rides tranche II commit and the last commit that changes package source before the tag (the 2026-09-06 tranche is `0100d3e` / `c77e0ab`) · `@modelcontextprotocol/sdk` 1.30.0, protocol `2025-11-25`.
...
`CHANGELOG.md` § `[1.5.0]` — https://github.com/HarpocGH/harpoc/blob/v1.5.0/CHANGELOG.md — 321 entries under Added (75), Changed (96), Removed (7), Fixed (128), Internal (14) and Notes (1).
