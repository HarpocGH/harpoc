...
**Figures at the tag:** 13 packages · 109 error codes · 36 audit event types · 5897 passing / 39 skipped / 315 files (win32 host) · `ci.yml` 6/6 legs (Linux, Windows, macOS × Node 22, 24) at run 34060765478 · e2e harness 376/376 fleet tests (381/381 with the unit file) at run 34060765473 — measured at `c77e0ab`, the standing-rides tranche's fix-forward and the last commit that changes package source before the tag (the tranche commit is `0100d3e`) · `@modelcontextprotocol/sdk` 1.30.0, protocol `2025-11-25`.
...
`CHANGELOG.md` § `[1.5.0]` — https://github.com/HarpocGH/harpoc/blob/v1.5.0/CHANGELOG.md — 313 entries under Added, Changed, Removed, Fixed, Internal and Notes.
